...
def distribute_work(base_url, wordlist, wordlist_file, ffuf_flags):
    ...
    if num_workers == 0:
        print("!! No workers present !!")
        return "Please spawn some workers :) \n"
    else:
        print(f"Loaded wordlist {len(wordlist)} lines long")
